...
foreach( $this->items as $k => $item ):
	...
	$canEditOwn = $user->authorise('core.edit.own',		'com_fbimporter');
	...
	// =================================================================================
		...
		if ($item->get('a_checked_out'))
			$content .= JHtml::_('jgrid.checkedout', $i, $item->get('a_checked_out'), $item->get('a_checked_out_time'), 'formats.', $canCheckin);
		
		if ($canEdit || $canEditOwn) 
			$content .= JHtml::link(JRoute::_('index.php?option=com_fbimporter&task=format.edit&id='.$item->a_id), $item->get('a_title')) ;
		
		
		if(JVERSION >= 3) :
			$content .= '<div class="small">'.JText::sprintf('JGLOBAL_LIST_ALIAS', $this->escape( $item->get('a_alias') )).'</div></div>' ;
			
			JHtml::_('dropdown.edit', $item->id, 'formats.');
	...
	// =================================================================================
		...
		$content = JHtml::_('jgrid.published', $item->a_published, $i, 'formats.', $canChange, 'cb', $item->a_publish_up, $item->a_publish_down);
