...
namespace Fbimporter\Component;

use Fbimporter\Provider\FbimporterProvider;
 ...
 * @since 1.0
 */
abstract class FbimporterComponent extends Component
{
	/**
	...
	public function prepare()
	{
		...
		// Register provider
		$this->container->registerServiceProvider(new FbimporterProvider);
