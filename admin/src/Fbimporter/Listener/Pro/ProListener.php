...
namespace Fbimporter\Listener\Pro;
...
class ProListener extends \JEvent
{
	...
	/**
	 * Fbimporter prepare content method
	...
	/**
	 * Fbimporter after display title method
	...
	/**
	 * Fbimporter before display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Fbimporter after display content method
	 * Method is called by the view and the results are imploded and displayed in a placeholder
	 *
	 * @param   string $context The context of the content being passed to the plugin.
	 * @param   object $article The content object.  Note $article->text is also available.
	...
	/**
	 * Fbimporter before save content method
	...
	/**
	 * Fbimporter after save content method
	...
	/**
	 * Fbimporter before delete method.
	 *
	...
	/**
	 * Fbimporter after delete method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
	 * @param   object $data    The data relating to the content that is to be deleted.
	 *
	...
	/**
	 * Fbimporter on change state method.
	 *
	 * @param   string $context The context for the content passed to the plugin.
