...
<div id="fbimporter" class="windwalker items tablelist row-fluid">
	<form action="<?php echo JURI::getInstance(); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
		...
		<table id="itemList" class="adminlist table table-striped modal-list">
			<thead>
			<tr>
				<!--TITLE-->
				<th class="center">
					<?php echo $grid->sortTitle('JGLOBAL_TITLE', 'item.title'); ?>
				</th>
				...
				<!--CREATED-->
				<th class="center">
					<?php echo $grid->sortTitle('JDATE', 'item.created'); ?>
				</th>
				...
				<th width="1%" class="nowrap center">
					<?php echo $grid->sortTitle('JGRID_HEADING_ID', 'item.id'); ?>
				</th>
			</tr>
			</thead>
